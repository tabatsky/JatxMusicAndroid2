...
interface MusicTransmitterView: MvpView {
    ...
    @StateStrategyType(OneExecutionStateStrategy::class) fun showSavePlaylistDialog()
    @StateStrategyType(OneExecutionStateStrategy::class) fun showLoadPlaylistDialog(playlistNames: List<String>)
